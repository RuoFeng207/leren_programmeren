...
verwacht =bedrag =76.61
krijgt = afronden_5cent (bedrag= 76.61 )
test ("Ik verwacht 76.61 euro",verwacht,krijgt)

verwacht =bedrag = 28.82
krijgt = afronden_5cent (bedrag=28.82 )
test ("Ik verwacht 28.82 euro",verwacht,krijgt)

verwacht =bedrag =2.23
krijgt = afronden_5cent (bedrag= 2.23)
test ("Ik verwacht 2.23 euro",verwacht,krijgt)

verwacht =bedrag =28.34
krijgt = afronden_5cent (bedrag= 28.34)
test ("Ik verwacht 28.34 euro",verwacht,krijgt)
