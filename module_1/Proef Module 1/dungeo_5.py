...
print("")
time.sleep(3)
print("Je kijkt wat beter en me heen en ziet 2 deuren, op een deur van staat kamer 2 en op de andere staat kamer 3")
...
if kamer == "2":
    ...
    print('Achter het standbeeld zie je 2 deuren, een gaat naar kamer 3 en de ander naar kamer 6')
    print("Welke kamer neem jij?")
